# Transforming the identified information into LOD 

Back to [home](../README.md)

<br/>

Linked Open Data (LOD) are structured data representing individuals identified by URIs, their properties (in the sense of values, DataType properties) and relationships to other individuals. Furthermore individuals are linked to other Semantic Web resources in order to facilitate informaion sharing or enrich your information with existing one.
